...
type OverloadUnionRecursive<TOverload, TAccumulator = unknown> =
  TOverload extends (...args: infer TArgs) => infer TReturn
    ? TAccumulator extends TOverload
      ? never
      :
 ...
 * constructor anyway.
 */
type ConstructorOverloadUnionRecursive<TOverload, TAccumulator = unknown> =
    ...
    ? TAccumulator extends TOverload
      ...
      :
          | ConstructorOverloadUnionRecursive<
              TAccumulator & TOverload,
              TAccumulator & (new (...args: TArgs) => TReturn) &
                ConstructorOverloadProps<TOverload>
            >
