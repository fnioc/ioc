...
| **Phase 3** — Integration & verification | 🟡 | In flight (feat-integration) — e2e transformer→di, progressive-enhancement parity, factory e2e, correctness suite. Phase 4 bootstrap running in parallel. |
